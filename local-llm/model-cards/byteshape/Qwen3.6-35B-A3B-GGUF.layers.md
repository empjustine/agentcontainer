---
model: byteshape/Qwen3.6-35B-A3B-GGUF
quants: Q4_K_S
file_Q4_K_S: Qwen3.6-35B-A3B-Q4_K_S-4.22bpw.gguf
tensor_count: 693
generator: local-llm/generate_layer_cards.py
generated: 2026-08-23 05:12 UTC
---

# Layer names — byteshape/Qwen3.6-35B-A3B-GGUF
...
| total tensors | 693 |
| non-layer tensors | 3 |
| attention blocks | 10 — 3, 7, 11, 15, 19, 23, 27, 31, 35, 39 |
| ssm blocks | 30 — 0, 1, 2, 4, 5, 6, 8, 9, 10, 12, 13, 14, 16, 17, 18, 20, 21, 22, 24, 25, 26, 28, 29, 30, 32, 33, 34, 36, 37, 38 |
| quants analyzed | Q4_K_S |

## Non-layer tensors

| tensor | shape | MiB (Q4_K_S) |
|---|---|---|
| `output.weight` | [2048 x 248320] | 272.8 |
| `output_norm.weight` | [2048] | 0.0 |
| `token_embd.weight` | [2048 x 248320] | 208.4 |
...
| tensor | shape | MiB (Q4_K_S) |
|---|---|---|
| `attn_k.weight` | [2048 x 512] | 0.4 |
| `attn_k_norm.weight` | [256] | 0.0 |
| `attn_norm.weight` | [2048] | 0.0 |
| `attn_output.weight` | [4096 x 2048] | 3.4 |
| `attn_q.weight` | [2048 x 8192] | 6.9 |
| `attn_q_norm.weight` | [256] | 0.0 |
| `attn_v.weight` | [2048 x 512] | 0.6 |
| `ffn_down_exps.weight` | [512 x 2048 x 256] | 144.0 |
| `ffn_down_shexp.weight` | [512 x 2048] | 0.4 |
| `ffn_gate_inp.weight` | [2048 x 256] | 2.0 |
| `ffn_gate_inp_shexp.weight` | [2048] | 0.0 |
| `ffn_gate_shexp.weight` | [2048 x 512] | 0.4 |
| `ffn_gate_up_exps.weight` | [2048 x 1024 x 256] | 220.0 |
| `ffn_up_shexp.weight` | [2048 x 512] | 0.4 |
| `post_attention_norm.weight` | [2048] | 0.0 |

### ssm blocks — 30 (0, 1, 2, 4, 5, 6, 8, 9, 10, 12, 13, 14, 16, 17, 18, 20, 21, 22, 24, 25, 26, 28, 29, 30, 32, 33, 34, 36, 37, 38)

| tensor | shape | MiB (Q4_K_S) |
|---|---|---|
| `attn_gate.weight` | [2048 x 4096] | 3.4 |
| `attn_norm.weight` | [2048] | 0.0 |
| `attn_qkv.weight` | [2048 x 8192] | 6.9 |
| `ffn_down_exps.weight` | [512 x 2048 x 256] | 110.0 |
| `ffn_down_shexp.weight` | [512 x 2048] | 0.3 |
| `ffn_gate_inp.weight` | [2048 x 256] | 2.0 |
| `ffn_gate_inp_shexp.weight` | [2048] | 0.0 |
| `ffn_gate_shexp.weight` | [2048 x 512] | 0.3 |
| `ffn_gate_up_exps.weight` | [2048 x 1024 x 256] | 220.0 |
| `ffn_up_shexp.weight` | [2048 x 512] | 0.3 |
| `post_attention_norm.weight` | [2048] | 0.0 |
| `ssm_a` | [32] | 0.0 |
| `ssm_alpha.weight` | [2048 x 32] | 0.0 |
| `ssm_beta.weight` | [2048 x 32] | 0.0 |
| `ssm_conv1d.weight` | [4 x 8192] | 0.1 |
| `ssm_dt.bias` | [32] | 0.0 |
| `ssm_norm.weight` | [128] | 0.0 |
| `ssm_out.weight` | [4096 x 2048] | 6.6 |
...
blk.30.ffn_gate_up_exps.weight
...
blk.31.ffn_gate_up_exps.weight
...
blk.32.ffn_gate_up_exps.weight
...
blk.33.ffn_gate_up_exps.weight
...
blk.34.ffn_gate_up_exps.weight
...
blk.35.ffn_gate_up_exps.weight
...
blk.36.ffn_gate_up_exps.weight
...
blk.37.ffn_gate_up_exps.weight
...
blk.38.ffn_gate_up_exps.weight
