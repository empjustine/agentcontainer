...
quants: UD-Q6_K, Q8_0
file_UD-Q6_K: gemma-4-26B-A4B-it-UD-Q6_K.gguf
file_Q8_0: gemma-4-26B-A4B-it-Q8_0.gguf
tensor_count: 658
generator: local-llm/generate_layer_cards.py
generated: 2026-08-25 04:26 UTC
---

# Layer names — unsloth/gemma-4-26B-A4B-it-GGUF
...
|---|---|---|---|
| `output_norm.weight` | [2816] | 0.0 | 0.0 |
| `rope_freqs.weight` | [256] | 0.0 | 0.0 |
| `token_embd.weight` | [2816 x 262144] | 748.0 | 748.0 |
...
| tensor | shape | MiB (UD-Q6_K) | MiB (Q8_0) |
|---|---|---|---|
| `attn_k.weight` | [2816 x 2048] | 5.8 | 5.8 |
| `attn_k_norm.weight` | [256] | 0.0 | 0.0 |
| `attn_norm.weight` | [2816] | 0.0 | 0.0 |
| `attn_output.weight` | [4096 x 2816] | 11.7 | 11.7 |
| `attn_q.weight` | [2816 x 4096] | 11.7 | 11.7 |
| `attn_q_norm.weight` | [256] | 0.0 | 0.0 |
| `ffn_down.weight` | [2112 x 2816] | 6.0 | 6.0 |
| `ffn_down_exps.scale` | [128] | 0.0 | 0.0 |
| `ffn_down_exps.weight` | [704 x 2816 x 128] | 257.1 | 257.1 |
| `ffn_gate.weight` | [2816 x 2112] | 6.0 | 6.0 |
| `ffn_gate_inp.scale` | [2816] | 0.0 | 0.0 |
| `ffn_gate_inp.weight` | [2816 x 128] | 1.4 | 1.4 |
| `ffn_gate_up_exps.weight` | [2816 x 1408 x 128] | 397.0 | 514.2 |
| `ffn_norm.weight` | [2816] | 0.0 | 0.0 |
| `ffn_up.weight` | [2816 x 2112] | 6.0 | 6.0 |
| `layer_output_scale.weight` | [1] | 0.0 | 0.0 |
| `post_attention_norm.weight` | [2816] | 0.0 | 0.0 |
| `post_ffw_norm.weight` | [2816] | 0.0 | 0.0 |
| `post_ffw_norm_1.weight` | [2816] | 0.0 | 0.0 |
| `post_ffw_norm_2.weight` | [2816] | 0.0 | 0.0 |
| `pre_ffw_norm_2.weight` | [2816] | 0.0 | 0.0 |
