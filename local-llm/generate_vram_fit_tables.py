...
Replaces the retired in-repo size-estimation scripts (see
...
list in ../lib/llamacpp-model-data.json, then renders:
...
def main():
    ...
    ap.add_argument("--update-model-data", action="store_true",
                    help="also reorder lib/llamacpp-model-data.json by the ranking")
    args = ap.parse_args()
