...
# jq compile gate for the sandbox description filters (lib/sandbox-*.jq).
#
...
# compile error.  Semantic mistakes are check-sandbox.sh's job, not this gate's.
log_info "jq compile (gating — lib/sandbox-*.jq)"
