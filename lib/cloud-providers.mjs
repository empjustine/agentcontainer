 ...
 * consumer's decision:
 *   - `coding-agent/generate-cloud-providers.mjs` consumes the
 ...
 *     generate-cloud-providers.mjs's full rows).
 ...
 * full-block layer is owned by generate-cloud-providers.mjs's full rows,
