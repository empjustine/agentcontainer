 ...
 *     pi-native trio (openrouter / opencode / opencode-go): pi ships these
 *     natively, so it only ever emits an override layer.
...
/**
 * The pi-native cloud trio: providers pi-coding-agent ships natively, where a
